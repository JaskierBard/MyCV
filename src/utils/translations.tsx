export const tabNames: { [key: string]: { [key: string]: string } } = {
    Polish: {
      ...
      answer: "Zmień język rozmowy na Polski. Podaj mi więcej informacji o twoim : ",
    ...
    UnitedKingdom: {
      ...
      answer: "Zmień język rozmowy na angielski. Give me more information about your:  ",
      interests: "intersts",
    ...
    Deutsch: {
      ...
      answer: "Zmień język rozmowy na niemiecki to ważne. Nie pros o zmianę języka i odpowiadaj po Niemiecku jak najlepiej umiesz. Geben Sie mir weitere Informationen zu Ihrem:  ",
